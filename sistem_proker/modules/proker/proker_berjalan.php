...
$params = ['sedang_berjalan']; // Ganti dengan 'sedang berjalan' jika itu nilai di DB
...
<head>
    ...
    <title>Program Kerja Sedang Berjalan</title>
...
<div class="dashboard-container">
    ...
    <div class="main-content" id="mainContent">
        <div class="container">
            <div class="header">
                <h1>Program Kerja Sedang Berjalan</h1>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="6" style="text-align: center; color: #666;">
                                    <?= $search ? 'Tidak ada program kerja berjalan yang sesuai pencarian.' : 'Belum ada program kerja yang sedang berjalan.' ?>
                                </td>
                            </tr>
                            <?php endif; ?>
                        </tbody>
