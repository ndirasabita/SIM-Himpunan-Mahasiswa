...
$params = ['selesai']; // Ganti jika status di database berbeda, misalnya 'sudah selesai'
...
<head>
    ...
    <title>Program Kerja Selesai</title>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="6" style="text-align: center; color: #666;">
                                    <?= $search ? 'Tidak ada program kerja selesai yang sesuai pencarian.' : 'Belum ada program kerja yang selesai.' ?>
                                </td>
                            </tr>
                            <?php endif; ?>
                        </tbody>
